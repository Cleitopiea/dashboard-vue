<template>
    <div class="flex items-center justify-center h-screen px-6 bg-gray-200 ">
      <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
        ...
        <div class="flex pl-36 pb-5">
          <img class="w-10 h-10" src="../assets/leaves-icon.png" />
        </div>
  
        <div class="flex items-center justify-center"> 
          <span class="text-2xl font-semibold text-gray-700 text-center">Aquatic Plants Metro <br> Dashboard </span>
        </div>
